...
EXT var F(smooth)(var*,var);
EXT var F(floatv)(var);
EXT var F(floatd)(var,var);
EXT var F(floatr)(var);
...
EXT var F(vec_cross)(VECTOR* a,VECTOR* b,VECTOR* c);
...
EXT var F(str_width)(char* s,FONT* font);
...
EXT var F(bmap_blit)(BMAP* bDest,BMAP* bSrc,VECTOR* vPos,VECTOR* vSize);
EXT var F(bmap_blitpart)(BMAP* bDest,BMAP* bSrc,VECTOR* vDestPos,VECTOR* vDestSize,VECTOR* vSrcPos,VECTOR* vSrcSize);
EXT var F(bmap_fill)(BMAP* bmap,COLOR* color,var alpha);
EXT var F(bmap_rendertarget)(BMAP* bmap,var num,var face);
EXT var F(bmap_zbuffer)(BMAP* bmap);
EXT var F(pixel_for_bmap)(BMAP*,var,var);
EXT var F(pixel_to_bmap)(BMAP*,var x,var y,var pixel);
EXT var F(pixel_for_vec)(COLOR*,var,var);
EXT var F(pixel_to_vec)(COLOR*,var*,var,var pixel);
...
EXT var F(ent_nextvertex)(ENTITY*,VECTOR*);
...
EXT var F(ent_setmesh)(ENTITY* ent,void* mesh,var num,var lod);
EXT CONTACT* F(ent_getvertex)(ENTITY *e,CONTACT* c,var num);
EXT CONTACT* F(ent_setvertex)(ENTITY *e,CONTACT* c,var num);
EXT var F(ent_clone)(ENTITY*);
EXT var F(ent_cloneskin)(ENTITY*);
...
EXT var F(ent_type)(ENTITY*);
EXT var F(ent_status)(ENTITY*,var mode);
...
EXT var F(path_scanpath)(ENTITY*,VECTOR* position,VECTOR* direction,ANGLE*);
...
EXT var F(view_to_light)(VIEW* view,var num,var mode);
...
EXT var F(pan_setevent)(PANEL*,var type,var number,EVENT event);
EXT var F(pan_setpos)(PANEL*,var type,var number,VECTOR* xy);
EXT var F(pan_setvar)(PANEL*,var type,var number,var* v);
...
EXT var F(txt_for_dir)(TEXT*,char *path);
EXT var F(txt_sort)(TEXT*);
EXT var F(txt_load)(TEXT*,char *filename);
EXT var F(txt_addstring)(TEXT *t,char *s);
...
EXT var F(draw_box3d)(VECTOR* vMin,VECTOR* vMax,COLOR*,var alpha);
EXT var F(draw_point3d)(VECTOR* vPos,COLOR*,var alpha,var size);
EXT var F(draw_quad)(BMAP* bmap,VECTOR* vPos,VECTOR* vOffs,
    VECTOR* vSize,VECTOR* vScale,COLOR* vColor,var alpha,var angle);
EXT var F(draw_text)(char* text,var,var,COLOR*);
EXT var F(draw_textmode)(char* fontname,var,var,var);

// multiplayer
EXT var F(proc_client)(var,EVENT);
EXT var F(proc_local)(var,EVENT);
EXT var F(send_data_to)(ENTITY*,void* buffer,var size);
EXT var F(send_data_id)(var client_id,void* buffer,var size);
EXT var F(send_skill)(var* skill,var mode);
EXT var F(send_skill_to)(ENTITY*,var* skill,var mode);
EXT var F(send_skill_id)(var client_id,var* skill,var mode);
EXT var F(send_string)(STRING*);
EXT var F(send_string_to)(ENTITY*,STRING*);
EXT var F(send_string_id)(var client_id,STRING*);
EXT var F(send_var)(void*);
EXT var F(send_var_to)(ENTITY*,void*);
EXT var F(send_var_id)(var client_id,void*);
EXT var F(session_connect)(char* sessionname,char *hostname);
EXT var F(session_open)(char* sessionname);
EXT var F(client_drop)(char* name);
EXT var F(client_drop_id)(var client_id);
...
EXT var F(wiimote_handle)(var num);

// misc
EXT var F(exec)(char* program,char *cmdline);
EXT var F(exec_wait)(char* program,char *cmdline);
...
EXT var F(ptr_remove)(void* object);
EXT void* F(ptr_for_handle)(var handle);
EXT var F(handle)(void* object);
