...
#define VISIBLE			SHOW    // panel / view / text visible
...
#define NOCAST			(1<<20) // ignore CAST entities
...
typedef struct {
	...
	float u1,v1;    // first coordinate set, used for shadow maps and nontiled textures
